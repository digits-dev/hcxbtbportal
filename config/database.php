    ...
    */
    ...
    'connections' => [
        ...
        'mysql2' => [
            ...
            'database' => env('DB2_DATABASE', 'your_second_db'),
        ...
        'dem' => [
            'driver' => 'mysql',
            'url' => env('DATABASE_DEM_URL'),
            'host' => env('DB_DEM_HOST', '127.0.0.1'),
            'port' => env('DB_DEM_PORT', '3306'),
            'database' => env('DB_DEM_DATABASE', 'forge'),
            'username' => env('DB_DEM_USERNAME', 'forge'),
            'password' => env('DB_DEM_PASSWORD', ''),
            'unix_socket' => env('DB_DEM_SOCKET', ''),
            'charset' => 'utf8mb4',
            'collation' => 'utf8mb4_unicode_ci',
            'prefix' => '',
            'prefix_indexes' => true,
