...
const ModeOfPaymentsAction = ({action, onClose, updateData}) => {
    ...
    const { data, setData, processing, reset, post, errors } = useForm({
        id: "" || updateData.id,
        payment_name: "" || updateData.payment_name,
    ...
    const handleFormSubmit = (e) => {
        e.preventDefault();
        Swal.fire({
            title: `<p class="font-poppins text-3xl" >Do you want ${action == 'Add' ? 'add' : 'update'} Mode of Payment?</p>`,
            ...
            if (result.isConfirmed) {
                ...
                if (action == 'Add'){
                    post('mode_of_payments/create', {
                        onSuccess: (data) => {
                            const { message, type } = data.props.auth.sessions;
                            handleToast(message, type);
                            router.reload({ only: ["mode_of_payments"] });
                            reset();
                            onClose();
                        },
                        onError: (error) => {
  ...
  return (
    <form onSubmit={handleFormSubmit} className='space-y-3'>
        ...
        <InputComponent
            ...
            onError={errors.payment_name}
            onChange={(e)=> setData("payment_name", e.target.value.toUpperCase())}
        />
        {action == 'Update' && 
            <>
                <DropdownSelect
        ...
        {action !== 'View' && 
            <div className='flex justify-end'>
                ...
                {processing ? 
                    ...
                    (
                        <span>
                            <i className={`fa-solid ${action === "Add" ? 'fa-plus' : 'fa-pen-to-square' } mr-1`}></i> {action === "Add" ? 'Add Payment Method' : 'Update Payment Method'}
                        </span>
                    )
                }
                </Button>  
...
export default ModeOfPaymentsAction